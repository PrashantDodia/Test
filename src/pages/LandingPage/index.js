...
const LandingPagePage = () => {
  return (
    <>
      <Column className="bg-white_A700 font-manrope items-center justify-end mx-[auto] w-[100%]">
        ...
        <Row className="items-center lg:mt-[56px] xl:mt-[71px] 2xl:mt-[80px] 3xl:mt-[96px] w-[83%]">
          <Column className="bg-red_100 lg:p-[32px] xl:p-[40px] 2xl:p-[46px] 3xl:p-[55px] rounded-radius20 w-[49%]">
            ...
            <Text
              className="font-normal leading-[180.00%] ml-[4px] lg:mt-[46px] xl:mt-[58px] 2xl:mt-[66px] 3xl:mt-[79px] not-italic text-gray_900 w-[88%]"
              variant="body2"
            >
            ...
            <Button
              className="font-semibold ml-[4px] lg:mt-[35px] xl:mt-[44px] 2xl:mt-[50px] 3xl:mt-[60px] lg:text-[11px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-center w-[28%]"
              shape="RoundedBorder10"
              size="lg"
              variant="FillGray900"
            >
          ...
          <Grid className="lg:gap-[17px] xl:gap-[21px] 2xl:gap-[24px] 3xl:gap-[28px] grid grid-cols-2 lg:ml-[17px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] w-[49%]">
            <Column className="bg-deep_orange_50 justify-start lg:p-[17px] xl:p-[21px] 2xl:p-[24px] 3xl:p-[28px] rounded-radius20 w-[100%]">
              <Img
            ...
            <Column className="bg-deep_orange_50 justify-start lg:p-[21px] xl:p-[26px] 2xl:p-[30px] 3xl:p-[36px] rounded-radius20 w-[100%]">
              <Img
            ...
            <Column className="bg-deep_orange_50 justify-center lg:p-[17px] xl:p-[22px] 2xl:p-[25px] 3xl:p-[30px] rounded-radius20 w-[100%]">
              <Img
              ...
              />
              <Text
                className="lg:mb-[17px] xl:mb-[22px] 2xl:mb-[25px] 3xl:mb-[30px] lg:ml-[3px] xl:ml-[4px] 2xl:ml-[5px] 3xl:ml-[6px] price_One"
                as="h4"
                variant="h4"
              >
            ...
            <Column className="bg-deep_orange_50 justify-start lg:p-[17px] xl:p-[21px] 2xl:p-[24px] 3xl:p-[28px] rounded-radius20 w-[100%]">
              ...
              />
              <Text
                className="lg:mb-[18px] xl:mb-[23px] 2xl:mb-[26px] 3xl:mb-[31px] lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] lg:mt-[14px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] text-gray_900 tracking-ls1 w-[auto]"
                as="h4"
                variant="h4"
              >
        ...
        <Row className="bg-gray_50 items-start justify-between lg:mt-[56px] xl:mt-[71px] 2xl:mt-[80px] 3xl:mt-[96px] lg:p-[35px] xl:p-[44px] 2xl:p-[50px] 3xl:p-[60px] w-[100%]">
          <List
            className="lg:gap-[116px] xl:gap-[145px] 2xl:gap-[164px] 3xl:gap-[196px] grid grid-cols-3 lg:mb-[4px] xl:mb-[5px] 2xl:mb-[6px] 3xl:mb-[7px] min-h-[auto] lg:ml-[49px] xl:ml-[62px] 2xl:ml-[70px] 3xl:ml-[84px] w-[65%]"
            orientation="horizontal"
          >
            <Column className="justify-start w-[100%]">
              <Button
              ...
              <Text className="price_One" as="h2" variant="h2">
                $15.4M
              </Text>
              <Text
                className="font-semibold leading-[140.00%] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[16px] lg:mt-[9px] text-bluegray_600 tracking-ls1 w-[100%]"
                variant="body1"
              >
                Owned from
                <br />
            ...
            <Column className="justify-start w-[100%]">
              ...
              <Text
                className="font-semibold xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[16px] lg:mt-[9px] text-bluegray_600 tracking-ls1 w-[auto]"
                variant="body1"
              >
        ...
        <Column className="justify-end 2xl:mt-[100px] 3xl:mt-[120px] lg:mt-[71px] xl:mt-[88px] w-[83%]">
          <Row className="items-center justify-between w-[100%]">
            ...
            <Row className="items-center justify-between w-[10%]">
              <Text
                className="font-bold text-orange_A700 w-[auto]"
                variant="body2"
              >
                Explore All
              </Text>
          ...
          <Row className="items-center mr-[auto] lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[65%]">
            <Text className="font-bold text-gray_900 w-[auto]" variant="body2">
              Resident Property
            </Text>
          ...
          <Grid className="lg:gap-[17px] xl:gap-[21px] 2xl:gap-[24px] 3xl:gap-[28px] grid grid-cols-3 lg:mt-[42px] xl:mt-[53px] 2xl:mt-[60px] 3xl:mt-[72px] w-[100%]">
            <Column className="grideye">
              <Img
                ...
                alt="image One"
              />
              <Column className="justify-start lg:ml-[14px] xl:ml-[17px] 2xl:ml-[20px] 3xl:ml-[24px] lg:mt-[21px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] w-[77%]">
                <Row className="items-center w-[100%]">
                  <Img
                    ...
                    alt="eye"
                  />
                  <Text className="location1" variant="body3">
                    2861 62nd Ave, Oakland, CA 94605
                  </Text>
                </Row>
                <Column className="items-center justify-start lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[81%]">
        ...
        <Column className="bg-gray_51 items-center justify-end lg:mt-[106px] xl:mt-[133px] 2xl:mt-[150px] 3xl:mt-[180px] xl:p-[106px] 2xl:p-[120px] 3xl:p-[144px] lg:p-[85px] w-[100%]">
          <Row className="items-center justify-between lg:mt-[21px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] rounded-radius10 w-[100%]">
            <Column className="rounded-radius10 w-[38%]">
              <Text
                className="leading-[140.00%] ml-[1px] text-gray_900 tracking-ls1 w-[92%]"
                as="h3"
                variant="h3"
              >
                Simple & easy way to find your dream Appointment
              ...
              <Text
                className="font-normal leading-[180.00%] lg:mt-[14px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] not-italic text-gray_700 w-[100%]"
                variant="body2"
              >
                Lorem Ipsum is simply dummy text of the printing and typesetting
          ...
          <Row className="items-start justify-between lg:mt-[106px] xl:mt-[133px] 2xl:mt-[150px] 3xl:mt-[180px] w-[100%]">
            ...
            <Column className="justify-start lg:mt-[44px] xl:mt-[55px] 2xl:mt-[62px] 3xl:mt-[74px] w-[38%]">
              <Text
                className="leading-[140.00%] ml-[1px] text-gray_900 tracking-ls1 w-[92%]"
                as="h3"
                variant="h3"
              ...
              <Column className="justify-start ml-[1px] lg:mt-[14px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] w-[61%]">
                <Row className="items-center w-[75%]">
                  <Img
                    ...
                    alt="checkmark"
                  />
                  <Text className="point" variant="body2">
                    Find excellent deals
                  </Text>
                </Row>
                <Row className="items-center xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] w-[100%]">
                  <Img
                    src="images/img_checkmark.svg"
                    className="arrowright"
                    alt="checkmark One"
                ...
                <Row className="items-center xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] w-[88%]">
                  <Img
                    src="images/img_checkmark.svg"
                    className="arrowright"
                    alt="checkmark Two"
              ...
              <Button
                className="font-semibold ml-[1px] lg:mt-[42px] xl:mt-[53px] 2xl:mt-[60px] 3xl:mt-[72px] lg:text-[11px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-center w-[29%]"
                shape="RoundedBorder10"
                size="lg"
                variant="FillGray900"
              >
        ...
        <Row className="items-center justify-center lg:mt-[130px] xl:mt-[162px] 2xl:mt-[183px] 3xl:mt-[219px] w-[70%]">
          <Img
            src="images/img_rectangle5591.png"
            className="lg:h-[286px] xl:h-[358px] 2xl:h-[403px] 3xl:h-[483px] rounded-radius8 w-[38%]"
            alt="Rectangle5591"
          />
          <Column className="lg:ml-[54px] xl:ml-[68px] 2xl:ml-[77px] 3xl:ml-[92px] w-[54%]">
            <Row className="items-center w-[75%]">
              <Column className="w-[83%]">
                ...
                <Text
                  className="font-semibold mt-[4px] text-gray_900 w-[auto]"
                  variant="body2"
                >
            ...
            <Text
              className="font-semibold leading-[165.00%] lg:mt-[21px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] text-gray_700 w-[100%]"
              as="h5"
              variant="h5"
            >
            ...
            <Row className="items-center lg:mt-[35px] xl:mt-[44px] 2xl:mt-[50px] 3xl:mt-[60px] w-[39%]">
              ...
              <Row className="items-center justify-between lg:ml-[21px] xl:ml-[26px] 2xl:ml-[30px] 3xl:ml-[36px] w-[34%]">
                <Text
                  className="font-bold text-orange_A700 w-[auto]"
                  variant="body2"
                >
        ...
        <Column className="bg-gray_900 items-center justify-start 2xl:mt-[100px] 3xl:mt-[120px] lg:mt-[71px] xl:mt-[88px] xl:p-[106px] 2xl:p-[120px] 3xl:p-[144px] lg:p-[85px] w-[100%]">
          <Column className="items-center justify-start w-[100%]">
            ...
            <List
              className="lg:gap-[17px] xl:gap-[21px] 2xl:gap-[24px] 3xl:gap-[28px] grid grid-cols-3 min-h-[auto] lg:mt-[42px] xl:mt-[53px] 2xl:mt-[60px] 3xl:mt-[72px] w-[100%]"
              orientation="horizontal"
            >
              <Column className="justify-start w-[100%]">
                <Img
                  ...
                  alt="image Thirteen"
                />
                <Text className="blog" as="h5" variant="h5">
          ...
          <Column className="bg-gray_401 items-center justify-end xl:mt-[106px] 2xl:mt-[120px] 3xl:mt-[144px] lg:mt-[85px] lg:p-[28px] xl:p-[35px] 2xl:p-[40px] 3xl:p-[48px] rounded-radius10 w-[58%]">
            <Text
              className="2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[8px] text-gray_900 tracking-ls1 w-[auto]"
              as="h4"
              variant="h4"
            >
            ...
            <Text
              className="font-normal leading-[180.00%] 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[8px] not-italic text-center text-gray_900 w-[76%]"
              variant="body2"
            >
              We helps businesses customize, automate and scale up their ad
              production and delivery.
            </Text>
            <Row className="items-center justify-center lg:mt-[21px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] rounded-radius10 w-[64%]">
              <Input
        ...
        <footer className="bg-white_A700 w-[100%]">
          <Column className="justify-start lg:mb-[56px] xl:mb-[71px] 2xl:mb-[80px] 3xl:mb-[96px] 2xl:mt-[100px] 3xl:mt-[120px] lg:mt-[71px] xl:mt-[88px] mx-[auto] w-[83%]">
            <Row className="font-markoone items-end w-[100%]">
              <Column className="justify-start w-[42%]">
                <Row className="items-center w-[26%]">
                  ...
                  />
                  <Text
                    className="font-normal 2xl:ml-[11px] 3xl:ml-[13px] lg:ml-[7px] xl:ml-[9px] not-italic text-orange_A700 w-[auto]"
                    variant="body1"
                  >
                    Relasto
                  </Text>
                </Row>
                <Column className="font-manrope justify-start lg:mt-[30px] xl:mt-[38px] 2xl:mt-[43px] 3xl:mt-[51px] w-[53%]">
                  <Text
                  ...
                  <Text
                    className="font-semibold lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] text-gray_900 w-[auto]"
                    variant="body3"
                  >
                  ...
                  <Img
                    ...
                    className="lg:h-[22px] xl:h-[27px] 2xl:h-[31px] 3xl:h-[37px] lg:mt-[28px] xl:mt-[35px] 2xl:mt-[40px] 3xl:mt-[48px] w-[75%]"
                    alt="socialmedia"
                  />
                </Column>
              </Column>
              <Column className="bg-white_A700 font-manrope items-center justify-start lg:mt-[14px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] w-[6%]">
                <Text
                  className="font-bold text-gray_900 w-[auto]"
                  variant="body2"
                >
                ...
                <Text
                  className="font-semibold leading-[270.00%] lg:mt-[14px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] text-gray_900 w-[99%]"
                  variant="body3"
                >
                  Home v1
                  <br />
              ...
              <Column className="bg-white_A700 font-manrope justify-start lg:ml-[59px] xl:ml-[73px] 2xl:ml-[83px] 3xl:ml-[99px] lg:mt-[14px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] w-[10%]">
                <Text
                  className="font-bold text-gray_900 w-[auto]"
                  variant="body2"
                >
                ...
                <Text
                  className="font-semibold leading-[270.00%] lg:mt-[14px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] text-gray_900 w-[100%]"
                  variant="body3"
                >
                  Listing v1
                  <br />
              ...
              <Column className="bg-white_A700 font-manrope justify-start lg:ml-[59px] xl:ml-[73px] 2xl:ml-[83px] 3xl:ml-[99px] lg:mt-[14px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] w-[10%]">
                ...
                <Text
                  className="font-semibold leading-[270.00%] lg:mt-[14px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] text-gray_900 w-[96%]"
                  variant="body3"
                >
                  Blog
                  <br />
              ...
              <Column className="bg-white_A700 font-manrope justify-start lg:ml-[59px] xl:ml-[73px] 2xl:ml-[83px] 3xl:ml-[99px] lg:mt-[14px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] w-[11%]">
                <Text
                  className="font-bold text-gray_900 w-[auto]"
                  variant="body2"
                >
